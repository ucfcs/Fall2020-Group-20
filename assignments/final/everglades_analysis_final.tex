...
\msection{Handwritten Digits Classification Example}
...
(1797, 64)
This tells us that there are 1797 instance samples and there are 64 attributes to each sample
The actual data attributes look like this:

\begin{center}
    \captionsetup{type=figure}
    \includegraphics[width=.9\linewidth]{media/digitarrays.png}
...
\begin{center}
    \captionsetup{type=figure}
    \includegraphics[width=.9\linewidth]{media/printdigits.png}
...
\begin{center}
    \captionsetup{type=figure}
    \includegraphics[width=.9\linewidth]{media/pltlmShow.png}
