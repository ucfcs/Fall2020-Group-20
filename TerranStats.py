...
for replay in sc2reader.load_replays(glob.glob('../**/*.SC2Replay', recursive=True)):
	...
	if replay.players[0].pick_race[0] == 'T' or replay.players[1].pick_race[0] == 'T':
		pt_dict = dict.fromkeys(unit_map['Terran'],0)
		pt_dict2 = dict.fromkeys(unit_map['Terran'],0)
		...
		for event in replay.events:
				...
				if type(event) is PlayerStatsEvent:
					if replay.players[0].pid == event.pid and replay.players[0].pick_race[0] == 'T':
						...
						T_gang.append([counter, event.second, replay.players[0].result, event.player, replay.players[0].pick_race[0], event.workers_active_count,
                                ...
                                pt_dict['barracksreactor'], pt_dict['barracksflying'], pt_dict['battlecruiser'], pt_dict['battlehellion'], pt_dict['bunker'], pt_dict['commandcenter'], pt_dict['commandcenterflying'],
                                pt_dict['cyclone'], pt_dict['engineeringbay'], pt_dict['factory'], pt_dict['factoryflying'], pt_dict['factoryreactor'], pt_dict['factorytechlab'], pt_dict['fusioncore'],
                                pt_dict['ghost'], pt_dict['ghostacademy'], pt_dict['hellion'], pt_dict['marauder'], pt_dict['marine'], pt_dict['medivac'],
                                pt_dict['missileturret'], pt_dict['mule'], pt_dict['orbitalcommand'], pt_dict['orbitalcommandflying'], pt_dict['planetaryfortress'], pt_dict['raven'],
                                pt_dict['reaper'], pt_dict['refinery'], pt_dict['scv'], pt_dict['sensortower'], pt_dict['siegetank'],
                                pt_dict['siegetanksieged'], pt_dict['starport'], pt_dict['starportflying'], pt_dict['starportreactor'], pt_dict['starporttechlab'],
                                pt_dict['supplydepot'], pt_dict['supplydepotlowered'], pt_dict['techlab'], pt_dict['thor'], pt_dict['viking'], pt_dict['vikingassault'], pt_dict['warhound'],
                                pt_dict['widowmine'], pt_dict['widowmineburrowed']])
					...
					if replay.players[1].pid == event.pid and replay.players[1].pick_race[0] == 'T':
						T_gang.append([counter, event.second, replay.players[1].result, event.player, replay.players[0].pick_race[0], event.workers_active_count,
                                ...
                                pt_dict2['barracksreactor'], pt_dict2['barracksflying'], pt_dict2['battlecruiser'], pt_dict2['battlehellion'], pt_dict2['bunker'], pt_dict2['commandcenter'], pt_dict2['commandcenterflying'],
                                pt_dict2['cyclone'], pt_dict2['engineeringbay'], pt_dict2['factory'], pt_dict2['factoryflying'],pt_dict['factoryreactor'], pt_dict2['factorytechlab'], pt_dict2['fusioncore'],
                                pt_dict2['ghost'], pt_dict2['ghostacademy'], pt_dict2['hellion'], pt_dict2['marauder'], pt_dict2['marine'], pt_dict2['medivac'],
                                pt_dict2['missileturret'], pt_dict2['mule'], pt_dict2['orbitalcommand'], pt_dict2['orbitalcommandflying'], pt_dict2['planetaryfortress'], pt_dict2['raven'],
                                pt_dict2['reaper'], pt_dict2['refinery'], pt_dict2['scv'], pt_dict2['sensortower'], pt_dict2['siegetank'],
                                pt_dict2['siegetanksieged'], pt_dict2['starport'], pt_dict2['starportflying'], pt_dict2['starportreactor'], pt_dict2['starporttechlab'],
                                pt_dict2['supplydepot'], pt_dict2['supplydepotlowered'], pt_dict2['techlab'], pt_dict2['thor'], pt_dict2['viking'], pt_dict2['vikingassault'], pt_dict2['warhound'],
                                pt_dict2['widowmine'], pt_dict2['widowmineburrowed']])
			...
			if type(event) is UnitBornEvent:
				if replay.players[0].pid == event.control_pid and replay.players[0].pick_race[0] == 'T':
					...
					elif event.unit_type_name.lower() == "vikingfighter":
						pt_dict['viking'] +=1
			...
			if type(event) is UnitDiedEvent:
				if replay.players[0].pid != event.killing_player_id and  replay.players[0].pick_race[0] == 'T':
					if event.unit.name.lower() in pt_dict:
						pt_dict[event.unit.name.lower()] -=1
				if replay.players[1].pid != event.killing_player_id and  replay.players[1].pick_race[0] == 'T':
...
columns =  ["Match ID", "Second", "Result", "Player", "Race", "Current Workers", "Food Used", "Food Available",
